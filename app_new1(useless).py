...
# 渲染首页
def render_home():
    st.markdown('<h1 class="main-header">中国网络文学探索平台</h1>', unsafe_allow_html=True)
    st.markdown('<p style="text-align: center; font-size: 1.2rem;">—— 清华大学水木书院秦奕扬</p>', unsafe_allow_html=True)
    st.markdown('<p style="text-align: center; margin: 20px 0;">你好，希望这个小小的网站能给你带来快乐和便捷！！！</p>', unsafe_allow_html=True)
    st.markdown("---")
...
#################################################################################################################################################################################################################################    
    ...
    if valid_images:
        ...
        st.image(bordered_images, width=200, caption=["" for _ in valid_images])

#################################################################################################################################################################################################################################
# 渲染历史页面
def render_history():
    st.markdown('<h1 class="main-header">中国网文的发展历史</h1>', unsafe_allow_html=True)
...
def render_categories():
    st.markdown('<h1 class="main-header">中国网文类型以及各类型书目</h1>', unsafe_allow_html=True)
    if st.button("返回首页", use_container_width=True):
        go_to_home()
...
def render_category_detail():
    ...
    st.markdown(f'<h1 class="main-header">{category}类网文小说</h1>', unsafe_allow_html=True)
...
def render_book_search():
    st.markdown('<h1 class="main-header">书荒查询</h1>', unsafe_allow_html=True)
    if st.button("返回首页", use_container_width=True):
        go_to_home()
...
def render_character_dialog():
    st.markdown('<h1 class="main-header">与角色对话</h1>', unsafe_allow_html=True)
    if st.button("返回首页", use_container_width=True):
        go_to_home()
...
def render_story_mode():
    st.markdown('<h1 class="main-header">穿书play</h1>', unsafe_allow_html=True)
    if st.button("返回首页", use_container_width=True):
        go_to_home()
...
def render_my_love_novel():
    st.markdown('<h1 class="main-header">开发者喜欢的小说！（加上一点介绍）</h1>', unsafe_allow_html=True)
    if st.button("返回首页", use_container_width=True):
        go_to_home()
...
#################################################################################################################################################################################################################################
def render_novel1():
    st.markdown('<h1 class="main-header">我不是戏神</h1>', unsafe_allow_html=True)
    if st.button('返回作者喜欢的书目',use_container_width=True):
        go_to_my_love_novel()
